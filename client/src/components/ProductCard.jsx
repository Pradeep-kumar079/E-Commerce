...
const ProductCard = ({ product, BASE_IMAGE_URL = "https://e-commerce-backend-2isg.onrender.com" }) => {
  ...
  const handleAddToCart = async (e) => {
    ...
    try {
      ...
      const res = await fetch("https://e-commerce-backend-2isg.onrender.com/api/cart/add-product", {
        method: "POST",
        headers: {

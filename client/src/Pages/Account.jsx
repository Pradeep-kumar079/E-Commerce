...
const fetchOrders = async () => {
  try {
    ...
    const response = await fetch("https://e-commerce-backend-2isg.onrender.com/api/user/orders", { // 🔥 FIX HERE
      method: "GET",
      headers: {
        Authorization: `Bearer ${token}`,
      },
  ...
  const fetchCartItems = async () => {
    try {
      ...
      const response = await fetch("https://e-commerce-backend-2isg.onrender.com/api/cart/", {
        method: "GET",
        headers: {
          Authorization: `Bearer ${token}`,
        },
